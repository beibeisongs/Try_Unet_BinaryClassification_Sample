...
Sky = [128, 128, 128]   # Description: The combination of the values of the array represents the RGB in labeled datas
Building = [128, 0, 0]
Pole = [192, 192, 128]
Road = [128, 64, 128]
Pavement = [60, 40, 222]
...
def trainGenerator(batch_size, train_path, image_folder, mask_folder, aug_dict, # Note: batch_size = 2; train_path = "data/membrane/train"; image_folder = "image"; mask_folder = "label"; aug_dict = {'shear_range': 0.05, 'height_shift_range': 0.05, 'horizontal_flip': True, 'fill_mode': 'nearest', 'rotation_range': 0.2, 'width_shift_range': 0.05, 'zoom_range': 0.05}
...
myGene = trainGenerator(2, 'data/membrane/train', 'image', 'label', data_gen_args, save_to_dir="D:/UNET：Realising Sample/unet-master/outputs")
